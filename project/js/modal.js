...
function getPrice(startPrice, mainDiv) {
    var template = function() {
        ...
        console.log(startPrice, day, hours, priseOfVisitors, time, op1, op2);

        mainDiv.getElementsByClassName("price")[0].value = startPrice;
        mainDiv.getElementsByClassName("price")[0].innerHTML = (startPrice * day * hours + priseOfVisitors + time) * op1 *  op2;
    }
